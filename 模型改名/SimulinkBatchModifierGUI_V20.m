function SimulinkBatchModifierGUI_V20()
% --- Simulink批量修改工具 V20.2.20 (“终极版”) ---
% =========================================================================
% ★★★★★【使 用 必 读】★★★★★
...
function createComponents()
    ...
    uilabel(app.Function1Panel, 'Text', '原前缀/关键词', 'Position', [15, 30, 90, 22]);
    app.OldStringField = uieditfield(app.Function1Panel, 'text', 'Position', [110, 30, 255, 22]);
    uilabel(app.Function1Panel, 'Text', '新前缀/关键词', 'Position', [15, 5, 90, 22]);
